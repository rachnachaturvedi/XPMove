<?php
class ModelReportDevice extends Model {
	// Sales
    ...
    public function getTotalWebsites() {
		$sql = "SELECT COUNT(device) AS total_website FROM `" . DB_PREFIX . "booking_status` WHERE device= '1'";

		
		$query = $this->db->query($sql);

		return $query->row['total_website'];
	}
        public function getTotal() {
		$sql = "SELECT COUNT(device) AS total FROM `" . DB_PREFIX . "booking_status` WHERE device= '1' OR device='2'";
     ...
     public function getTotalApp() {
		$sql = "SELECT COUNT(device) AS total_app FROM `" . DB_PREFIX . "booking_status` WHERE device= '2'";

		
		$query = $this->db->query($sql);

		return $query->row['total_app'];
	}
