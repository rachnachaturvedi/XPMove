<?php
class ModelOrderCustomField extends Model {
	public function addCustomField($data) {
		...
		foreach ($data['custom_field_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "custom_field_description SET custom_field_id = '" . (int)$custom_field_id . "', language_id = '" . (int)$languagre_id . "', name = '" . $this->db->escape($value['name']) . "'");
		}
