...
?>
                <tr>
                  <td class="text-center"><?php if (in_array($labour['id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $labour['id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $labour['id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $labour['name']; ?></td>
                    <td class="text-left"><?php echo $labour['address']; ?></td>
                    <td class="text-left"><?php echo $labour['number']; ?></td>
             
                  <td class="text-right"><a href="<?php echo $labour['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button_filter').on('click', function() {
   // alert("hello");
	...
	var url = 'index.php?route=details/labour&token=<?php echo $_GET["token"]; ?>';
