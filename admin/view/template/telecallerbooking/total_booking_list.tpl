            ...
            <table class="table table-bordered table-hover">
              <thead>
                ...
                <td class="text-left"><?php if ($sort == 'os.name') { ?>
                  ...
                  <td class="text-right"><?php echo $column_rcv; ?></td>
                    <td class="text-right"><?php echo $column_up; ?></td>
                </tr>
              </thead>
              <tbody>
...
?>
                ...
                <!--  <td class="text-center"><?php if (in_array($order['order_id'], $selected)) { ?>
                  ...
                  <td class="text-right"><?php echo round($order['distance']); ?></td>
                  <!--<td class="text-left"><?php echo $order['vehicle_type_name']; ?></td>
                  <td class="text-left"><?php echo $order['total_price']; ?></td>-->
                  <td class="text-left"><?php echo date('d-m-Y H:i:s',strtotime($order['deliver_time'])); ?></td>
                   
                   <!--<td class="text-left"><?php echo date('d-m-Y H:m:s',strtotime($order['deliver_time'])); ?></td>-->
                    <td class="text-left"><?php echo $order['status']; ?></td>
                     <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a></td>
            
                    <?php if($order['assigned_to_transporter']==''){ ?>
                     <td class="text-right"><a href="<?php echo $order['href']; ?>" data-toggle="tooltip" title="Assign" class="btn btn-info"><?php echo $asign_to; ?></a>
                      </td>
                    
                    <td class="text-right"><a href="<?php echo $order['update']; ?>" data-toggle="tooltip" title="Update" class="btn btn-info" disabled="disabled">Update Amount<?php //echo isset($update_amu)?update_amu:""; ?></a>
                        </td>
                    
                     <td class="text-right"><a href="<?php echo $order['delete']; ?>" data-toggle="tooltip" title="Payment" class="btn btn-info" disabled="disabled"><?php echo $payment; ?></a>
                      </td>
         
                    
                    <?php } ?>  
                <?php if(($order['assigned_to_transporter']==1) && ($order['amount_cal']==0.00) && ($order['status_id']!=5)){ ?>
                       <td class="text-right"><a href="<?php echo $order['href']; ?>" data-toggle="tooltip" title="Assign" class="btn btn-info" disabled="disabled"><?php echo $asign_to; ?></a>
                      </td>
                    <td class="text-right"><a href="<?php echo $order['update']; ?>" data-toggle="tooltip" title="Update" class="btn btn-info">Update Amount<?php //echo $update_amu; ?></a>
                      </td> 
                    ...
                    <?php } else if($order['assigned_to_transporter']==1 && $order['status_id']==5){ ?>
    
                            <td class="text-right"><a href="<?php echo $order['href']; ?>" data-toggle="tooltip" title="Update" class="btn btn-info" disabled="disabled">Assign</a>
                      </td>
                    <td class="text-right"><a href="<?php echo $order['update']; ?>" data-toggle="tooltip" title="Update" class="btn btn-info" disabled="disabled">Update Amount<?php //echo $update_amu; ?></a>
                      </td> 
              
                    <td class="text-right"><a href="<?php echo $order['delete']; ?>" data-toggle="tooltip" title="Payment" class="btn btn-info" disabled="disabled"><?php echo $payment; ?></a>
                      </td>
                    <?php }else if($order['amount_cal']!=0.00 && $order['assigned_to_transporter']==1){ ?>
                      <td class="text-right"><a href="<?php echo $order['href']; ?>" data-toggle="tooltip" title="Assign" class="btn btn-info" disabled="disabled"><?php echo $asign_to; ?></a>
                      </td>
<td class="text-right"><a href="<?php echo $order['update']; ?>" data-toggle="tooltip" title="Update" class="btn btn-info" disabled="disabled">Update Amount<?php //echo $update_amu; ?></a>
                        </td>
       
                   <td class="text-right"><a href="<?php echo $order['delete']; ?>" data-toggle="tooltip" title="Payment" class="btn btn-info"><?php echo $payment; ?></a>
                      </td>
                       </tr>
