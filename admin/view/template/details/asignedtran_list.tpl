  ...
  <div class="page-header">
    ...
    <!--  <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['href']; ?>">Assigned Bookings</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> Assigned Bookings</h3>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>    
                    <td class="text-left"><?php if ($sort == 'address') { ?>
                    <a href="<?php echo $sort_address; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_vehicle; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_address; ?>"><?php echo $column_vehicle; ?></a>
                    <?php } ?></td>   
                    <td class="text-left"><?php if ($sort == 'address') { ?>
                    <a href="<?php echo $sort_address; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_driver; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_address; ?>"><?php echo $column_driver; ?></a>
                    <?php } ?></td>   
                    <td class="text-left"><?php if ($sort == 'address') { ?>
                    <a href="<?php echo $sort_address; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_model; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_address; ?>"><?php echo $column_model; ?></a>
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'address') { ?>
                    <a href="<?php echo $sort_address; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_address; ?>"><?php echo $column_status; ?></a>
                    <?php } ?></td>
...
?>
                <tr>
                  <!--<td class="text-center"><?php if (in_array($asign['id'], $selected)) { ?>
                    ...
                    <td class="text-left"><?php echo $asign['vehicle_no']; ?></td>
                    <td class="text-left"><?php echo $asign['driver_name']; ?></td>
                    <td class="text-left"><?php echo $asign['mobile_no']; ?></td>
                    <td class="text-left"><?php echo $asign['name']; ?></td>
             
                 <td class="text-right"><a href="<?php echo $asign['view']; ?>" data-toggle="tooltip" title="View" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                      <a href="<?php echo $asign['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-info"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
<script>
	...
	var url = 'index.php?route=details/booking_asignedtran&token=<?php echo $_GET["token"]; ?>';
