      ...
      <div class="panel-body">
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" name="filter_booking_id" value="<?php echo $filter_booking_id; ?>" placeholder="<?php echo $label_filter_name; ?>" id="input-booking-id" class="form-control" onkeypress="runAddress(event)"/>
              </div> 
                   
                    <div class="form-group">
                <label class="control-label" for="input-margin-amount"><?php echo $label_filter_number; ?></label>
                <input type="text" name="filter_margin_amount" value="<?php echo $filter_margin_amount; ?>" placeholder="<?php echo $label_filter_number; ?>" id="input-margin-amount" class="form-control" onkeypress="runAddress(event)"/>
              </div>   
                ...
                <label class="control-label" for="input-booking_id"><?php echo $label_filter_customer; ?></label>
                <input type="text" name="filter_customer_name" value="<?php echo $filter_customer_name; ?>" placeholder="<?php echo $label_filter_customer; ?>" id="input-booking-id" class="form-control" onkeypress="runAddress(event)"/>
              </div> 
            <label class="control-label" for="input-total-paid"><?php echo $label_total_bal; ?></label>
                      
                       <input type="text" name="filter_total_paid" value="<?php echo $filter_total_paid; ?>" placeholder="<?php echo $label_total_bal; ?>" id="input-balance" class="form-control" onkeypress="runAddress(event)"/>  
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="filter_total_amu" value="<?php echo $filter_total_amu; ?>" placeholder="<?php echo $label_filter_address; ?>" id="input-total-amount" class="form-control" onkeypress="runAddress(event)"/>
              </div> 
                 <div class="form-group">
                  <div class="form-group">
                <label class="control-label" for="input-bal"><?php echo $label_total_paid; ?></label>
                   <input type="text" name="filter_total_balance" value="<?php echo $filter_total_balance; ?>" placeholder="<?php echo $label_total_paid; ?>" id="input-total-paid" class="form-control" onkeypress="runAddress(event)"/>
          ...
          <div class="row" style="font-size:15px;">
              <div class="form-group">
               ...
               <?php 
$asined_list=isset($asined_list)?$asined_list:"";   
if ($asined_list) { $total=0;
$margin=0;
$paid=0;
$balance=0;
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <a href="<?php echo $sort_number; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_first; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_number; ?>"><?php echo $column_first; ?></a>
                    <?php } ?></td>
                ...
                <tr>
                  <!--<td class="text-center"><?php if (in_array($asign['id'], $selected)) { ?>
                    ...
                    <td class="text-left"><a href="<?php echo $asign['new_link']; ?>" ><?php echo $asign['booking_id']; ?></a></td>
                     <td class="text-left"><?php echo $asign['customer']; ?></td>
