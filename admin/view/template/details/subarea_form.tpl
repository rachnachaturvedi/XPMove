           ...
           <select name="area" class="form-control" disabled>
               <option value=0>Select Area</option>
                         ...
                         <?php if ($area['area_id'] == $_GET['area_id']) { ?>
                          <option value="<?php echo $area['area_id']; ?>"  selected="selected"><?php echo $area['area_name']; ?></option>
							  <?php } else { ?>
          ...
          <div class="form-group">
            ...
            <label class="col-sm-2 control-label" for="input-subarea"><?php echo $entry_subarea; ?></label>
             <div class="col-sm-10">
              ...
              <input type="hidden" name="area_id" value="<?php echo $_GET['area_id']; ?>" placeholder="<?php echo $entry_subarea; ?>" id="area_id" class="form-control" />
                 </div>
                  </div>
            <?php }else{ ?>
...
function addDiscount() {
	 ...
	 html += '  <td class="text-left">';
        html +='<input type="text" name="subarea[' + discount_row + '][sub_area]">';
    	html +='</td>';
