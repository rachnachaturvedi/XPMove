          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-city"><?php echo $label_city; ?></label>
                <input type="text" name="filter_city" value="<?php echo $filter_city; ?>" placeholder="<?php echo $label_city; ?>" id="input-number" class="form-control" />
              </div>
...
$('#button_filter').on('click', function() {
   // alert("hello");
	...
	var url = 'index.php?route=details/city&token=<?php echo $_GET["token"]; ?>';
