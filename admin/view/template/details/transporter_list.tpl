<?php $driver_list=isset($driver_list)?$driver_list:""; ?>
                ...
                <tr>
                 <!-- <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>-->
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <a href="<?php echo $sort_number; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_licence; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_number; ?>"><?php echo $column_licence; ?></a>
                    <?php } ?></td>   
                    <td class="text-left"><?php if ($sort == 'number') { ?>
                    <a href="<?php echo $sort_number; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_transporter; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_number; ?>"><?php echo $column_transporter; ?></a>
                    <?php } ?></td>    
                    <td class="text-left"><?php if ($sort == 'number') { ?>
                    <a href="<?php echo $sort_number; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_city; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_number; ?>"><?php echo $column_city; ?></a>
                    <?php } ?></td> 
                    <td class="text-left"><?php if ($sort == 'number') { ?>
                    <a href="<?php echo $sort_number; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sub; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_number; ?>"><?php echo $column_sub; ?></a>
                    <?php } ?></td>
...
?>
                <tr>
                  <!--<td class="text-center"><?php if (in_array($driver['id'], $selected)) { ?>
                    ...
                    <?php } ?></td>-->
                  <td class="text-left"><?php echo $driver['vehicle_type']; ?></td>
                    <td class="text-left"><?php echo $driver['model']; ?></td>
                    <td class="text-left"><?php echo $driver['vehicle_no']; ?></td>
                    <td class="text-left"><?php echo $driver['licence_no']; ?></td>
                    <td class="text-left"><?php echo $driver['name']; ?></td>
                    <td class="text-left"><?php echo $driver['city']; ?></td>
                    <td class="text-left"><?php echo $driver['sub_area']; ?></td>
...
$('#button_filter').on('click', function() {
   // alert("hello");
	...
	var url = 'index.php?route=details/transporter_vehicle&token=<?php echo $_GET["token"]; ?>';
