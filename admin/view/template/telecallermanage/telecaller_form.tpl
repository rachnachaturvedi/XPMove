...
<div id="content">
 ...
 <?php
          ...
          {
?>
          <a href="<?php echo $change_password?>"><button type="button" id="button-filter" class="btn btn-primary pull-right"><?php echo $button_change_password; ?></button></a>
...
?>
 ...
 <?php if ($error_address) { ?>
            ...
            <div class="col-sm-10">
              <input type="text" name="ph_no" value="<?php if(isset($ph_no))echo $ph_no?>" placeholder="<?php echo $entry_ph_no; ?>" id="input-ph-no" maxlength="10" class="form-control" />
 <?php if ($error_mobile) { ?>
...
<div class="form-group">
            ...
            <div class="col-sm-10">
                      <input type="text" name="username" value="<?php if(isset($username))echo $username?>" placeholder="<?php echo $entry_username; ?>" id="input-username" class="form-control" />
