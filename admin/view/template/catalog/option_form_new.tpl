        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-option" class="form-horizontal">
          ...
          <table id="option-value" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <?php foreach ($vendor_values as $vendor_value) { ?>
              <tr id="option-value-row<?php echo $option_value_row; ?>">

                                    <td style="width:300px">
                    
                    <input type="hidden" name="vendor_value[<?php echo $option_value_row; ?>][vendor_value_id]" value="<?php echo $vendor_value['vendor_value_id']; ?>" />
              
                  <div class="input-group">
                    <input type="text" name="vendor_value[<?php echo $option_value_row; ?>][vendor_description]; ?>]" value="<?php echo isset($vendor_value['vendor_description']) ? $vendor_value['vendor_description'] : ''; ?>" placeholder="<?php echo $entry_vendor_description; ?>" class="form-control" />
                  </div>
                  <?php if (isset($error_vendor_value[$option_value_row])) { ?>
                  <div class="text-danger"><?php echo $error_vendor_value[$option_value_row]; ?></div>
                  <?php } ?>
              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                <td style='width:300px'><input type="hidden" name="option_value[<?php echo $option_value_row; ?>][option_value_id]" value="<?php echo $option_value['option_value_id']; ?>" />
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
...
function addOptionValue() {
	html  = '<tr id="option-value-row' + option_value_row + '">';	
     ...
     html += '  <td style="width:300px"><input type="hidden" name="vendor_value[' + option_value_row + '][option_value_id]" value="" />';
	html += '    <div class="input-group">';
	html += '<input type="text" name="vendor_value[' + option_value_row + '][vendor_description]" value="" placeholder="<?php echo $entry_vendor_description; ?>" class="form-control" />';
    html += '    </div>';
	html += '  </td>';
      html += '  <td style="width:300px"><input type="hidden" name="option_value[' + option_value_row + '][option_value_id]" value="" />';
	<?php foreach ($languages as $language) { ?>
	html += '    <div class="input-group">';
