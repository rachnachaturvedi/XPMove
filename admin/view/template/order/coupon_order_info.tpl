            ...
            <table class="table table-bordered">
             ...
             <!-- <tr>
              ...
              <tr>
                ...
                <td><?php echo $booking_customer[0]['store_id']; ?></td>
              </tr>
              <tr>
                <td><?php echo $text_customer; ?></td>
                <td><?php echo $booking_customer[0]['firstname']; ?></a></td>
              </tr>
              ...
              <tr>
                ...
                <td><?php echo $booking_customer[0]['booking_time']; ?></td>
              </tr>
              <tr>
                <td><?php echo $text_date_modified; ?></td>
                <td><?php echo $booking_customer[0]['delivering_time']; ?></td>
              </tr>
            </table>
          </div>
          <div class="tab-pane" id="tab-payment">
            <table class="table table-bordered">
              <tr>
                ...
                <td><?php echo $booking_customer[0]['firstname']; ?></td>
              </tr>
              <tr>
                <td><?php echo $text_lastname; ?></td>
                <td><?php echo $booking_customer[0]['lastname']; ?></td>
              </tr>
              
              <tr>
                <td><?php echo $text_address; ?></td>
                <td><?php echo $booking_customer[0]['address']; ?></td>
              </tr>
