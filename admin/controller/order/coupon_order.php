<?php
class ControllerOrderCouponOrder extends Controller {
	private $error = array();
...
$insert = $this->model_order_coupon_order->insertBooking($status,$notify,$comment,$booking_id);
    ...
    public function delete() {
		...
		$this->load->model('order/coupon_order');
        $this->getList();
        $delete = $this->model_order_coupon_order->insertBooking($status,$notify,$comment,$booking_id);
	...
	public function delete1() {
		...
		if (isset($response['success'])) {
			...
			$this->response->redirect($this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$data['add'] = $this->url->link('order/coupon_order/add', 'token=' . $this->session->data['token'], 'SSL');
     ...
     if (isset($this->request->get['filter_form_address'])) {
		...
		$data['sort_order'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
		$data['sort_formaddress'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=bs.form_address' . $url, 'SSL');
		$data['sort_toaddress'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=bs.to_address' . $url, 'SSL');
		$data['sort_distance'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=bs.distance' . $url, 'SSL');
		$data['sort_customer'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, 'SSL');
		$data['sort_vehicle'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=vt.vehicle_type_name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_ddate'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=bs.delivering_time' . $url, 'SSL');
		$data['sort_bdate'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=bs.booking_time' . $url, 'SSL');
		$data['sort_price'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=tbp.total_price' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=os.name' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . '&sort=o.date_modified' . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('order/coupon_order_list.tpl', $data));
	}
	...
	public function getForm() {
		...
		$data['cancel'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . $url, 'SSL');
	...
	public function info() {
       ...
       // print_r($order_info);die;
        ...
        $this->load->language('order/coupon_order');
			...
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('sale/coupon_order', 'token=' . $this->session->data['token'] . $url, 'SSL')
			);
        ...
        $data['cancel'] = $this->url->link('order/coupon_order', 'token=' . $this->session->data['token'] . $url, 'SSL');
           $data['header'] = $this->load->controller('common/header');
			$data['column_left'] = $this->load->controller('common/column_left');
			$data['footer'] = $this->load->controller('common/footer');
			$this->response->setOutput($this->load->view('order/coupon_order_info.tpl',$data));
