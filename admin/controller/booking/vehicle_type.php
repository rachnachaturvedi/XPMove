...
class ControllerDetailsVehicleType extends Controller {
    ...
    public function delete() {
		...
		if (isset($this->request->post['selected']))
			...
			$this->response->redirect($this->url->link('details/vehicle_type', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
      ...
      if (isset($this->request->get['filter_name'])) {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('details/vehicle_type', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('details/vehicle_type/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
	
		$data['delete'] = $this->url->link('details/vehicle_type/delete', 'token=' . $this->session->data['token'] . $url, 'SSL'); 
		...
		$data['vehicle_list'][] = array(
				...
				'price'  => $result['vehicle_type_price'],
                 'edit'       => $this->url->link('details/vehicle_type/edit', 'token=' . $this->session->data['token'] . '&id=' . $result['vehicle_type_id'] .'&name=' . $result['vehicle_type_name'] .'&price=' . $result['vehicle_type_price'] . $url, 'SSL')
...
$data['service_center'] = $this->language->get('service_center');
    ...
    protected function getFormadd() {
        ...
        if (!isset($this->request->get['id'])) {
			...
			$data['action'] = $this->url->link('details/vehicle_type/edit', 'token=' . $this->session->data['token'] .'&id='.$this->request->get['id'].'&name='.$this->request->get['name'].'&price='.$this->request->get['price'] . $url, 'SSL');
