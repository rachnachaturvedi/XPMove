<?php
class ControllerSaleBooking extends Controller {
	private $error = array();
	...
	public function info() {
        ...
        $this->load->model('sale/booking');
                $booking_id=$this->request->get['booking_status_id'];
        		$data['booking_details'] = $this->model_sale_booking->getBookingDetails($booking_id);
    	$data['breadcrumbs'] = array();
		...
		$data['breadcrumbs'][] = array(
         ...
         $data['text_booking_status_id'] = $this->language->get('text_booking_id');
          $data['text_customer_name'] = $this->language->get('text_customer_name');
          $data['text_booking_date'] = $this->language->get('text_booking_date');
            $data['text_booking_status'] = $this->language->get('text_booking_status');
...
$data['cancel'] = $this->url->link('common/dashboard', 'token=' . $this->session->data['token'] , 'SSL');
			$this->response->setOutput($this->load->view('sale/booking_info.tpl', $data));
