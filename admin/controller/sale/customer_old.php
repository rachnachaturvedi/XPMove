		...
		foreach ($results as $result) {
			...
			$data['customers'][] = array(
				...
				//'edit'           => $this->url->link('sale/customer/edit', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id'].'&vehicle_id=' . $result['vehicle']. ', 'SSL')
                                'edit'   => $this->url->link('sale/customer/edit', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id']. '&state_id=' . $result['state_id']. '&telephone=' . $result['telephone'].'&username=' . $result['username']. '&address=' . $result['address']. '&city_id=' . $result['city_id']. '&pincode=' . $result['pincode'], 'SSL'),  
