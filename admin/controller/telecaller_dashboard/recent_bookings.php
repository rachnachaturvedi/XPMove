<?php
class ControllerTelecallerDashboardRecentBookings extends Controller {
	public function index() {
		$this->load->language('telecaller_dashboard/recent_bookings');
		...
		$results = $this->model_sale_booking->getLatestBookings($telecaller_id);

    

		foreach ($results as $result) {
			$data['latest_bookings'][] = array(
		...
		return $this->load->view('telecaller_dashboard/recent_bookings.tpl', $data);
	}
}