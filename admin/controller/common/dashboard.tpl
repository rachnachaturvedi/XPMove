...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-3 col-sm-7"><?php echo $sale; ?></div>
              <div class="col-lg-3 col-md-3 col-sm-7"><?php echo $device; ?></div>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-md-12 col-sm-12 col-sx-12"> <?php echo $recent_bookings; ?> </div>
    </div>
          <div class="row">
