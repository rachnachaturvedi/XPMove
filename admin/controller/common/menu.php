...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['text_transporter_add'] = $this->language->get('text_transporter_add');
        $data['text_transporter'] = $this->language->get('text_transporter');
        $data['text_vehicle_description'] = $this->language->get('text_vehicle_description');
        ...
        $data['text_meta_data'] = $this->language->get('text_meta_data');
		$data['text_addbooking'] = $this->language->get('text_addbooking');
        $data['text_vehicle'] = $this->language->get('text_vehicle');
        $data['text_telecallermanage'] = $this->language->get('text_telecallermanage');
        $data['text_payement_details'] = $this->language->get('text_payement_details');
        $data['text_driver'] = $this->language->get('text_driver');
        $data['text_vendor'] = $this->language->get('text_vendor');
        $data['payement_details'] = $this->language->get('payement_details');
        $data['text_labour'] = $this->language->get('text_labour');
         $data['text_area'] = $this->language->get('text_area');
         $data['text_city'] = $this->language->get('text_city');
         $data['text_subarea'] = $this->language->get('text_subarea');
         $data['text_carmake'] = $this->language->get('text_carmake');
         $data['text_carmodel'] = $this->language->get('text_carmodel');
        ...
        $data['text_booking'] = $this->language->get('text_booking');
          $data['text_booking_add'] = $this->language->get('text_booking_add');
        $data['text_booking_history'] = $this->language->get('text_booking_history');
        $data['text_notasigned'] = $this->language->get('text_notasigned');
        $data['text_asigned'] = $this->language->get('text_asigned');
        $data['text_assign_to'] = $this->language->get('text_assign_to');
        ...
        $data['text_compound_transporter'] = $this->language->get('text_compound_transporter');

		$data['home'] = $this->url->link('common/dashboard', 'token=' . $this->session->data['token'], 'SSL');
        $data['booking'] = $this->url->link('addbooking/addbooking', 'token=' . $this->session->data['token'], 'SSL');
        
        $data['asigned'] = $this->url->link('order/assign_telecaller', 'token=' . $this->session->data['token'], 'SSL');
        $data['notasigned'] = $this->url->link('details/notbooking_asigned', 'token=' . $this->session->data['token'], 'SSL');
         $data['assign'] = $this->url->link('order/assign_telecaller/add', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['meta_data'] = $this->url->link('setting/store_data', 'token=' . $this->session->data['token'], 'SSL');
        $data['labour'] = $this->url->link('details/labour', 'token=' . $this->session->data['token'], 'SSL');
        $data['area'] = $this->url->link('details/area', 'token=' . $this->session->data['token'], 'SSL');
        $data['subarea'] = $this->url->link('details/subarea', 'token=' . $this->session->data['token'], 'SSL');
         $data['carmake'] = $this->url->link('details/carmake', 'token=' . $this->session->data['token'], 'SSL');
        $data['carmodel'] = $this->url->link('details/carmodel', 'token=' . $this->session->data['token'], 'SSL');
         $data['add_vendor'] = $this->url->link('details/vendor/add', 'token=' . $this->session->data['token'], 'SSL');
        $data['vendor'] = $this->url->link('details/vendor', 'token=' . $this->session->data['token'], 'SSL');
        $data['vehicle_description'] = $this->url->link('details/vehicle_description', 'token=' . $this->session->data['token'], 'SSL');
        $data['driver'] = $this->url->link('details/driver_management', 'token=' . $this->session->data['token'], 'SSL');
        $data['vehicle'] = $this->url->link('details/vehicle_type', 'token=' . $this->session->data['token'], 'SSL');
        $data['telecallermanage'] = $this->url->link('telecallermanage/telecallermanage', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['city'] = $this->url->link('details/city', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['addbooking'] = $this->url->link('addbooking/addbooking/add', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['payement_details'] = $this->url->link('details/paid_payment', 'token=' . $this->session->data['token'], 'SSL');
        $data['compound_transporter'] = $this->url->link('details/compound_transporter', 'token=' . $this->session->data['token'], 'SSL');
