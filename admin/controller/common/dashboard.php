...
class ControllerCommonDashboard extends Controller {
	public function index() {
        ...
        $data['booking'] = $this->load->controller('dashboard/booking');
		$data['sale'] = $this->load->controller('dashboard/sale');
        $data['device'] = $this->load->controller('dashboard/device');
		$data['customer'] = $this->load->controller('dashboard/customer');
		$data['online'] = $this->load->controller('dashboard/online');
        $data['non-assigned'] = $this->load->controller('dashboard/non-assigned');
        ...
        $data['recent_bookings'] = $this->load->controller('dashboard/recent_bookings');
