...
class ControllerDashboardOnline extends Controller {
	public function index() {
        ...
        // $data['non-assigned'] = $this->model_report_customer->getTotalNonAssigned();
		...
		$data['total_not_assigned'] = $this->model_report_customer->getTotalNotAssigned();
		$data['online'] = $this->url->link('details/notbooking_asigned', 'token=' . $this->session->data['token'], 'SSL');
