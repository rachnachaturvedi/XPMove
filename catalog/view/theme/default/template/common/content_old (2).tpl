		...
		<div class="intro">
			...
			<form role="form" action="<?php echo $direction_map?>" method="post" id="register-form" novalidate="novalidate">
             ...
             <div class="form-group select one-third">
                   ...
                   <div class="form-group select one-fourth" style="margin-left:428px;">                            							<label>&nbsp;</label>
...
document.getElementById('txtAutocomplete_off').value = place;
		...
		<div class="black cta">
			<div class="wrap">
				<p class="wow fadeInLeft">We Have All The Solutions For Your Transport</p>
		...
		<div class="services boxed white" id="services">
			...
			<article class="one-fourth wow fadeIn" data-wow-delay=".2s">
				...
				<div class="details">
					<h4><a href="#"><span class="circle"><img src="catalog/view/javascript/bootstrap/images/images (5).jpg" style="height:50px;"></span></a></h4>
...
<!--<a class="more" title="Read more" href="#">Read more</a>-->
    ...
    <div class="services boxed white" id="services">
			...
			<!-- Item -->
			<article class="one-fourth wow fadeIn" data-wow-delay=".4s" style="margin-left:335px;">
				<figure class="featured-image">
					<div class="overlay">
						<a href="#" class="expand">+</a>
					</div>
