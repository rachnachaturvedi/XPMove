...
<?php if ($error_warning) { ?>
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <!--<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>-->
      ...
      <p style="text-align:center"><?php echo $text_account_already; ?></p>
    ...
    <?php echo $column_right; ?></div>-->
              ...
              <?php } ?>
            <?php echo isset($already_exist)?$already_exist:"";?>
            ...
            <div class="three-fourth">
              ...
              <?php } ?>
								...
								<input type="text" id="mobile_no" name="mobile_no" placeholder="<?php echo $entry_mobile_no; ?>"/>
              ...
              <?php } ?>
						...
						<div class="f-row">
							...
							<label for="confirm_password">Confirm Password<span style="color:red">*</span></label>
								<input type="password" name="confirm_password" placeholder="<?php echo $entry_confirm_password; ?>" id="input-password" />
