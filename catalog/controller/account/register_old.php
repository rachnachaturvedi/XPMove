...
//$this->response->redirect($this->url->link('account/account', '', 'SSL'));
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
         ...
         $this->model_account_customer->addCustomers($this->request->post);
...
//$this->customer->login($this->request->post['email'], $this->request->post['password']);
        ...
        //$customer_id=$this->customer->getId();
                ...
                $this->model_account_booking->addOrder($this->session->data['from'],$this->session->data['to'],$this->session->data['distance'],$this->session->data['distance_price'],$this->session->data['vehicle_id'], $this->session->data['dep-date'],$this->session->data['labour_id'],$this->session->data['total_labour_price'],$customer_id);
                
               
                
                $this->response->redirect($this->url->link('account/order_success'));
            }
